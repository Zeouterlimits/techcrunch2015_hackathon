        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('aolDubTechCrunch2015App.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-aolDubTechCrunch2015App-error');
                                var entityKey = httpResponse.headers('X-aolDubTechCrunch2015App-params');
                                if (errorHeader) {
                                    ...
                                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                                        ...
                                        var fieldName = $translate.instant('aolDubTechCrunch2015App.' + fieldError.objectName + '.' + convertedField);
