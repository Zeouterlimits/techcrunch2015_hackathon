...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def v1 = new Venue(username: "brazenHeadManager", name: "Brazen Head", latitude: "51.5443601", longitude: "-0.0201986", profilePicPath: "C:/wtf.png", phoneNumber: "353860567862", location: "Queen Elizabeth Olympic Park, London", email: "brazenHead@cayman.com", password: "password").save()
