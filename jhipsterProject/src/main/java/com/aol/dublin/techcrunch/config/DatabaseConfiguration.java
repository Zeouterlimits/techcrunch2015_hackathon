package com.aol.dublin.techcrunch.config;

import com.aol.dublin.techcrunch.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.aol.dublin.techcrunch.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.aol.dublin.techcrunch.repository.search")
